...
class __TwigTemplate_397d749a774e5c8cc0c97224ac2129aa55eab185c771334e659ef90fee0c8d7a extends Twig_Template
{
...
{% for month,items in archives_data %}
    <li>
    \t<a href=\"{{ base_url }}/polet500/schede/{{ config.plugins.archives.taxonomy_names.month }}{{ config.system.param_sep }}{{ month|date('M_Y')|lower|e('url') }}\">
